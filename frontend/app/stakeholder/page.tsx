          ...
          <div className="space-y-8">
            ...
            <div className="grid md:grid-cols-4 gap-6">
              {stats.map((stat, index) => (
                <div key={index} className={`p-6 rounded-2xl transition-all duration-300 ${
                    ...
                    <div key={index} className="flex items-start space-x-3">
                      <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${
                        ...
                        <activity.icon className={`w-4 h-4 ${
                          ...
                          activity.type === 'verification' ? 'text-purple-600' :
                          'text-orange-600'
                        }`} />
                      </div>
        ...
        {activeTab === 'projects' && (
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              ...
              <button className="bg-gradient-to-r from-blue-600 to-green-600 text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg transition-all duration-300 flex items-center space-x-2">
            ...
            <div className="grid lg:grid-cols-2 gap-6">
              {projects.map((project) => (
                <div key={project.id} className={`p-6 rounded-2xl transition-all duration-300 ${
                  isDark ? 'bg-gray-800' : 'bg-white shadow-lg'
                }`}>
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              ...
              <div className="flex space-x-3">
                ...
                <button className="bg-gradient-to-r from-blue-600 to-green-600 text-white px-6 py-2 rounded-lg font-semibold">
              ...
              <div className={`p-6 rounded-2xl transition-all duration-300 ${
                ...
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className={`text-2xl font-bold ${isDark ? 'text-white' : 'text-gray-900'}`}>21,250</p>
                  </div>
                </div>
              ...
              <div className={`p-6 rounded-2xl transition-all duration-300 ${
                ...
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className={`text-2xl font-bold ${isDark ? 'text-white' : 'text-gray-900'}`}>18,750</p>
                  </div>
                </div>
              ...
              <div className={`p-6 rounded-2xl transition-all duration-300 ${
                ...
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className={`text-2xl font-bold ${isDark ? 'text-white' : 'text-gray-900'}`}>2,500</p>
                  </div>
                </div>
            ...
            <div className={`p-6 rounded-2xl transition-all duration-300 ${
              ...
              <div className="space-y-4">
                {projects.map((project) => (
                  <div key={project.id} className={`flex items-center justify-between p-4 rounded-lg ${
